    ...
    authors: [
      {
        ...
        witness: {
          ...
          publicKey:
            "d5e27eee7d4970317fd1b36e54aefac95c31154e1b20637f7e2ca1eb52dd0746",
          signature:
            "8a1d2c5e16fb9c91c502a2381eab2d5b51f159b386a1924024652ab8a46dba4efb55363f51f87f6a0b0a4dce2195ff0cb224733256dcde1b221ea304297e480b",
        },
      },
      {
        ...
        witness: {
          witnessAlgorithm: "ed25519",
          publicKey:
            "f127c0824564745561896c3ce3e6e5961f2acaab5f5f149c65f2e81ff549360a",
          signature:
            "0c89d2e7d8ef7496578ad963bb8c7fef9293dd521f96431a36fdbf3c1715a988ef23b7710eaa2737644332ff684411a3b5a8d6f5672832415700887de189f30a",
        },
      },
      {
        ...
        witness: {
          witnessAlgorithm: "ed25519",
          publicKey:
            "c6089a76a380b282b078189f011dc53b05df1ea4804558444128d4849ad88e5b",
          signature:
            "b05910f9992f9a94faa2b89a306e2f29207f5999bbf7d9b0fd0399e845050679b4fa9972d6e603a816d96c63d05d8843e454454580483a8812124cef92ca9d0a",
        },
      },
      {
        ...
        witness: {
          witnessAlgorithm: "ed25519",
          publicKey:
            "ce0e80c60a0e16a9254d613dfadbcbdca2ac60ec105dc2f136636807d75dab01",
          signature:
            "54e6156d297d4cbb4fc3c103b1b8f29dd3c43153ac7b0c57a33002a1f18746ad72a9346e6eba440e70f2528c9dab1962c94e5e62562261fe2379d47346594c05",
        },
      },
    ],
      ...
      references: [
        {
          ...
          "@type": "Other",
          label:
            "Proposed (and approved) budget - gov_action1h4ygjv0hjfj3lmafcm76rpdzcm8vsvj9k5wejn3npyxwxm3fesnqqw9kxxz",
        ...
        },
        {
          ...
          "@type": "Other",
          label:
            "Current Net-Change Limit - gov_action1nd3t833j7v5sz65k3tp9yyvztw60sjcjgcgjr37682s3m7frwrusqmd2k80",
                  ...
                  {result === null ? (
                    ...
                    >
                      <div className="flex justify-center items-center">
                        <div className="flex justify-center items-center text-lg font-semibold text-white transition-all duration-300">
                  ...
                  <div className="space-y-6">
                    <div className="flex justify-between items-center mb-4">
                      <div className="flex items-center">
                        <span className="text-lg font-semibold text-gray-700">JSON-LD Governance Metadata</span>
                        <div className="relative ml-2 group">
                          ...
                          <span className="tooltip absolute top-[1.125rem] left-0 bg-gray-800 text-white text-xs rounded py-2 px-3 min-w-[300px] border border-gray-700 shadow-2xl backdrop-blur-sm">
                            Paste your CIP-100 governance metadata JSON. Expected format: JSON-LD document with @context, authors array, hashAlgorithm, and body fields. Supports ed25519, CIP-0008, CIP-0030 witness algorithms.
                          </span>
                        </div>
                      </div>
                    ...
                    <div className="flex gap-4 pt-2">
                      ...
                      >
                        {isLoading ? "Verifying..." : "Verify Governance Metadata"}
                      </button>
                      <button
                        type="button"
                        onClick={() => {
            ...
            <div className="backdrop-blur-sm bg-white/80 border border-cf-blue-200 rounded-xl shadow-xl overflow-hidden">
              ...
              <div className="p-8">
                {result && result.authors && result.authors.length > 0 ? (
                  <div>
                    <h2 className="text-2xl font-bold text-cf-blue-900 mb-6 text-center">
                  ...
                  <div className="flex items-center justify-center h-64">
                    <div className="text-center text-gray-500">
                      ...
                      <p className="text-sm">Submit governance metadata to see verification results here</p>
                    </div>
                  </div>
                )}
              </div>
